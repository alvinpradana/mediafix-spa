    ...
    <div class="container">
        <div class="row" >
            <div class="col-lg-6 text-center text-lg-start" data-aos="fade-right">
                ...
                <p class="para-light">
                    Untuk mengetahui kondisi unit repair, anda bisa memasukkan kode / nomor nota pada form disamping. 
                    Atau anda bisa menghubungi Admin kami melalui kontak yang tersedia.
                </p>
            </div>
            <div class="col-lg-6 d-flex align-items-center" data-aos="fade-down">
                <div class="input-group my-3">
                    <input type="text" class="form-control p-2" placeholder="Enter your invoice code" aria-label="Recipient's email">
                    <button class="btn-secondary text-light" type="button">Submit</button>
                </div>
            </div>
        </div>
