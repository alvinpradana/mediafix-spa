                    ...
                    <table class="table table-responsive table-bordered mt-2">
                        ...
                        <tr v-for="(unit, index) in form.units" :key="unit.id">
                            ...
                            <td>
                                ...
                                <small class="invalid-feedback" v-if="errors['units.'+ index +'.unit_cost']">
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-sm-12 col-md-12 pr-4">
                                    <div class="form-group row">
                                        ...
                                        <textarea class="form-control txt" rows="6" v-model="form.notes" id="notes" :class="{'is-invalid': errors.notes}" placeholder="Catatan nota!"></textarea>
