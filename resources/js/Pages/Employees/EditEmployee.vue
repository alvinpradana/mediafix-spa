                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group col mb-4">
                                ...
                                <input v-model="form.employee_name" type="name" class="form-control" placeholder="Enter name">
                                <small class="text-danger" v-if="errors.employee_name">{{ errors.employee_name[0] }}</small>
                            </div>
                            <div class="form-group col mb-4">
                                <label for="phone_number">Phone</label>
                                <input v-model="form.phone_number" type="text" class="form-control" placeholder="Enter phone number">
                                <small class="text-danger" v-if="errors.phone_number">{{ errors.phone_number[0] }}</small>
                            </div>
                            <div class="form-group col mb-4">
                                <label for="employee_email">Email</label>
                                <input v-model="form.employee_email" type="email" class="form-control" placeholder="Enter email">
                        ...
                        <div class="col-md-6">
                            <div class="form-group col mb-4">
                                ...
                                <input v-model="form.employee_division" type="text" class="form-control" placeholder="Enter employee division">
                                <small class="text-danger" v-if="errors.employee_division">{{ errors.employee_division[0] }}</small>
                            </div>
                            <div class="form-group col mb-4">
                                <label for="employee_address">Address</label>
                                <textarea v-model="form.employee_address" type="address" class="form-control" placeholder="Enter address" rows="7"></textarea>
